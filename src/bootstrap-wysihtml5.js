!function($, wysi) {
    ...
    var tpl = {
            ...
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-link-modal modal hide fade'>" +
                ...
                "<div class='modal-footer'>" +
                  ...
                  "<a href='#' class='btn btn-defaultbtn-primary' data-dismiss='modal'>" + locale.link.insert + "</a>" +
                "</div>" +
              "</div>" +
        ...
        "color": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li class='dropdown'>" +
              "<a class='btn btn-defaultdropdown-toggle" + size + "' data-toggle='dropdown' href='#' tabindex='-1'>" +
